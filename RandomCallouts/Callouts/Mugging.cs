...
namespace RandomCallouts.Callouts
{
    ...
    public class Mugging : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            Aggressor.Inventory.GiveNewWeapon("WEAPON_PISTOL", 500, true);
            ...
            Functions.PlayScannerAudioUsingPosition("CITIZENS_REPORT_03 CRIME_POSSIBLE_MUGGING UNITS_RESPOND_CODE_3", this.spawnPoint);
